...
<section class="movies">
	<img src="img/green_left.png" alt="green_bgr"/>
	<div class="section-header">
		<div class="container">
			<div class="row">
				<div class="col-xs-12 movies-header">
					<h2>Movies</h2>
				</div>
			</div>
		</div>
...
<section class="about">
	<div class="section-header triangle"><h2>About</h2></div>
	<div class="container">
...
<section class="gallery">
	<img src="img/green_right.png" alt="green-bgr"/>
	<div class="section-header">
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
